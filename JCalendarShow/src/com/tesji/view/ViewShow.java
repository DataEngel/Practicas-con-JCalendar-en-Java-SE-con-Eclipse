...
public class ViewShow extends JFrame {
	...
	public ViewShow() {
		...
		btnMes.setBounds(290, 10, 136, 21);
		...
		JButton btnYear = new JButton("Show Year ");
		btnYear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "The year is " + (calendar.getCalendar().get(Calendar.YEAR)+1));  
			}
		});
		btnYear.setBounds(177, 210, 104, 21);
